...
SECRET_KEY = '8-(j3^13uuji=-k=-of37bv0^+-ikpgo-m9fe=yswirh(jtmx('
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',  # 保存到文件，自动切
            'filename': os.path.join(BASE_LOG_DIR, "bbs_debug.log"),  # 日志文件
            'maxBytes': 1024 * 1024 * 50,  # 日志大小 50M
            'backupCount': 5,  # 日志文件备份的数量
            'formatter': 'standard',
            'encoding': 'utf-8',
...
HAYSTACK_SEARCH_RESULTS_PER_PAGE = 9999999999999999  # 不分页
